...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>(
            Coordinate,
            game.GetGroup(GameMatcher.Coordinate),
            (e, c) => ((CoordinateComponent)c).value));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithCoordinate(this GameContext context, UnityEngine.Vector2Int value) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>)context.GetEntityIndex(Contexts.Coordinate)).GetEntity(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
