...
public partial class GameContext {
    ...
    public GameEntity SetMapSize(UnityEngine.Vector2Int newSize) {
        if (hasMapSize) {
        ...
        entity.AddMapSize(newSize);
        return entity;
    }

    public void ReplaceMapSize(UnityEngine.Vector2Int newSize) {
        var entity = mapSizeEntity;
        if (entity == null) {
            entity = SetMapSize(newSize);
        } else {
            entity.ReplaceMapSize(newSize);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddMapSize(UnityEngine.Vector2Int newSize) {
